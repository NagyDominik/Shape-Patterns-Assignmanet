...
public class LogicController
{
    ...
    /**
     * This method goes through the list of shapes that the user wants to draw
     * and draws them to the next available coordinate. Depending on the name of
    ...
    /**
     * Makes an ArrayList of strings that contains the name, size and the color
     * of the shapes that are on the drawing list.
     *
    ...
    /**
     * Sets the drawing pattern according to the pattern the returned pattern
     * string.
     *
     * @param pattern
     */
